...
class AdminOrderbackController extends AdminInfo0Controller
{
    private $order_type;
     ...
     * @adminMenu(
     *     'name'   => '客户售后列表',
     *     'parent' => 'orderback/AdminIndex/default',
     *     'display'=> true,
     *     'hasView'=> true,
     *     'order'  => 1,
     *     'icon'   => '',
    ...
    public function add()
    {
        ...
        $order_type=$this->request->param('order_type',1,'intval');
...
//             $this->error('订单不可申请售后');
    ...
    public function edit()
    {
        ...
        $this->assign('order_type',$info['order_type']); 
        return $this->fetch();  
    }
    /**
     * 订单售后编辑
